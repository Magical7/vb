...
public class Calc {
    ...
    public static void main(String[] args) {
        ...
        try {
            InputStream in = inputFile == null ? System.in : new FileInputStream("src/vb/week4/xcalc/"+ inputFile + ".calc");
            ...
            if (options.contains(Option.CODE_GENERATOR)) {
            	...
            	TreeNodeStream nodes = new BufferedTreeNodeStream(tree);
                CalcCodeGenerator codeGenerator = new CalcCodeGenerator(nodes);
                codeGenerator.setOut(new PrintStream(new File("src/vb/week4/assembler/" + inputFile + ".tasm")));
