...
public class ForrestChecker extends TreeParser {
	...
	// $ANTLR start "forrest"
	// ForrestChecker.g:28:1: forrest : ^( PROGRAM program_lines ) ;
	public final void forrest() throws RecognitionException {
		try {
			// ForrestChecker.g:29:2: ( ^( PROGRAM program_lines ) )
			// ForrestChecker.g:29:6: ^( PROGRAM program_lines )
			{
	...
	// ForrestChecker.g:32:1: program_lines : ( ( declaration )* expr )* ;
	public final void program_lines() throws RecognitionException {
		try {
			// ForrestChecker.g:33:2: ( ( ( declaration )* expr )* )
			// ForrestChecker.g:33:4: ( ( declaration )* expr )*
			{
			// ForrestChecker.g:33:4: ( ( declaration )* expr )*
			loop2:
			while (true) {
				...
				switch (alt2) {
				case 1 :
					// ForrestChecker.g:33:5: ( declaration )* expr
					{
					// ForrestChecker.g:33:5: ( declaration )*
					loop1:
					while (true) {
						int alt1=2;
						...
						switch (alt1) {
						case 1 :
							// ForrestChecker.g:33:6: declaration
							{
	...
	// ForrestChecker.g:36:1: declaration : ( ^( VAR id= IDENTIFIER (type= CHAR |type= BOOL |type= INT ) ) | ^( CONSTANT id= IDENTIFIER expr ) );
	public final void declaration() throws RecognitionException {
		...
		try {
			// ForrestChecker.g:40:2: ( ^( VAR id= IDENTIFIER (type= CHAR |type= BOOL |type= INT ) ) | ^( CONSTANT id= IDENTIFIER expr ) )
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// ForrestChecker.g:40:4: ^( VAR id= IDENTIFIER (type= CHAR |type= BOOL |type= INT ) )
					{
					match(input,VAR,FOLLOW_VAR_in_declaration104); 
					match(input, Token.DOWN, null); 
					id=(ForrestTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_declaration108); 
					// ForrestChecker.g:40:24: (type= CHAR |type= BOOL |type= INT )
					int alt3=3;
					switch ( input.LA(1) ) {
					case CHAR:
						{
					...
					break;
				case 2 :
					// ForrestChecker.g:42:4: ^( CONSTANT id= IDENTIFIER expr )
					{
	...
	public final void expr() throws RecognitionException {
		...
		try {
			// ForrestChecker.g:51:2: ( ^( BECOMES id= IDENTIFIER expr ) | ^( EXPR_WHILE while_comp do_comp ) | ^( EXPR_IF if_comp then_comp ( else_comp )? ) | ^( ( LOGOR | LOGAND ) expr expr ) | ^( ( GREATER | SMALLER | GREATEREQ | SMALLEREQ ) expr expr ) | ^( ( EQUALS | NOTEQUALS ) expr expr ) | ^( ( PLUS | MINUS | TIMES | DIVIDE | MODULO ) expr expr ) | ^( ( POSITIVE | NEGATIVE ) expr ) | ^( ( NOT ) expr ) | ^( COMPOUND program_lines ) | IDENTIFIER | NUMBER | ( TRUE | FALSE ) | CHARACTER | read | print )
			int alt6=16;
			switch ( input.LA(1) ) {
			case BECOMES:
				{
			...
			switch (alt6) {
				case 1 :
					...
					break;
				case 2 :
					// ForrestChecker.g:56:4: ^( EXPR_WHILE while_comp do_comp )
					{
					...
					break;
				case 3 :
					// ForrestChecker.g:63:4: ^( EXPR_IF if_comp then_comp ( else_comp )? )
					{
					...
					symtab.closeScope();
					// ForrestChecker.g:67:4: ( else_comp )?
					int alt5=2;
					...
					switch (alt5) {
						case 1 :
							// ForrestChecker.g:67:5: else_comp
							{
					...
					break;
				case 4 :
					// ForrestChecker.g:76:4: ^( ( LOGOR | LOGAND ) expr expr )
					{
					...
					break;
				case 5 :
					// ForrestChecker.g:78:4: ^( ( GREATER | SMALLER | GREATEREQ | SMALLEREQ ) expr expr )
					{
					...
					break;
				case 6 :
					// ForrestChecker.g:80:4: ^( ( EQUALS | NOTEQUALS ) expr expr )
					{
					...
					break;
				case 7 :
					// ForrestChecker.g:82:4: ^( ( PLUS | MINUS | TIMES | DIVIDE | MODULO ) expr expr )
					{
					...
					break;
				case 8 :
					// ForrestChecker.g:84:4: ^( ( POSITIVE | NEGATIVE ) expr )
					{
					...
					break;
				case 9 :
					// ForrestChecker.g:86:4: ^( ( NOT ) expr )
					{
					// ForrestChecker.g:86:6: ( NOT )
					// ForrestChecker.g:86:7: NOT
					{
					...
					break;
				case 10 :
					// ForrestChecker.g:88:6: ^( COMPOUND program_lines )
					{
					...
					break;
				case 11 :
					// ForrestChecker.g:93:4: IDENTIFIER
					{
				...
				case 12 :
					...
					break;
				case 13 :
					// ForrestChecker.g:95:4: ( TRUE | FALSE )
					{
					...
					break;
				case 14 :
					// ForrestChecker.g:96:4: CHARACTER
					{
	...
	// ForrestChecker.g:101:1: while_comp : ^( WHILE program_lines ) ;
	public final void while_comp() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestChecker.g:105:2: ( ^( WHILE program_lines ) )
			// ForrestChecker.g:105:4: ^( WHILE program_lines )
			{
	...
	// $ANTLR start "do_comp"
	// ForrestChecker.g:109:1: do_comp : ^( DO program_lines ) ;
	public final void do_comp() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestChecker.g:113:2: ( ^( DO program_lines ) )
			// ForrestChecker.g:113:4: ^( DO program_lines )
			{
	...
	// $ANTLR start "if_comp"
	// ForrestChecker.g:117:1: if_comp : ^( IF program_lines ) ;
	public final void if_comp() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestChecker.g:121:2: ( ^( IF program_lines ) )
			// ForrestChecker.g:121:4: ^( IF program_lines )
			{
	...
	// ForrestChecker.g:125:1: then_comp : ^( THEN program_lines ) ;
	public final void then_comp() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestChecker.g:129:2: ( ^( THEN program_lines ) )
			// ForrestChecker.g:129:4: ^( THEN program_lines )
			{
	...
	// ForrestChecker.g:133:1: else_comp : ^( ELSE program_lines ) ;
	public final void else_comp() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestChecker.g:137:2: ( ^( ELSE program_lines ) )
			// ForrestChecker.g:137:4: ^( ELSE program_lines )
			{
	...
	// $ANTLR start "print"
	// ForrestChecker.g:149:1: print : ^( PRINT ( expr )+ ) ;
	public final void print() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestChecker.g:153:2: ( ^( PRINT ( expr )+ ) )
			// ForrestChecker.g:153:4: ^( PRINT ( expr )+ )
			{
			match(input,PRINT,FOLLOW_PRINT_in_print612); 
			match(input, Token.DOWN, null); 
			// ForrestChecker.g:153:12: ( expr )+
			int cnt8=0;
			loop8:
			while (true) {
				int alt8=2;
