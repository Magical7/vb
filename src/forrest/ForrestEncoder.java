// $ANTLR 3.5 ForrestEncoder.g 2013-07-03 21:18:20
...
public class ForrestEncoder extends TreeParser {
	...
	// $ANTLR start "forrest"
	// ForrestEncoder.g:29:1: forrest : ^( PROGRAM program_lines ) ;
	public final void forrest() throws RecognitionException {

		fw.startProgram();

		try {
			// ForrestEncoder.g:33:2: ( ^( PROGRAM program_lines ) )
			// ForrestEncoder.g:33:4: ^( PROGRAM program_lines )
			{
	...
	// ForrestEncoder.g:40:1: program_lines : ( ( declaration )* expr )* ;
	public final void program_lines() throws RecognitionException {
		try {
			// ForrestEncoder.g:41:2: ( ( ( declaration )* expr )* )
			// ForrestEncoder.g:41:4: ( ( declaration )* expr )*
			{
			// ForrestEncoder.g:41:4: ( ( declaration )* expr )*
			loop2:
			while (true) {
				...
				switch (alt2) {
				case 1 :
					// ForrestEncoder.g:41:5: ( declaration )* expr
					{
					// ForrestEncoder.g:41:5: ( declaration )*
					loop1:
					while (true) {
						int alt1=2;
						...
						switch (alt1) {
						case 1 :
							// ForrestEncoder.g:41:6: declaration
							{
	...
	// ForrestEncoder.g:45:1: declaration : ( ^( VAR IDENTIFIER ( CHAR | BOOL | INT ) ) | ^( CONSTANT IDENTIFIER expr ) );
	public final void declaration() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestEncoder.g:49:2: ( ^( VAR IDENTIFIER ( CHAR | BOOL | INT ) ) | ^( CONSTANT IDENTIFIER expr ) )
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// ForrestEncoder.g:49:4: ^( VAR IDENTIFIER ( CHAR | BOOL | INT ) )
					{
					...
					break;
				case 2 :
					// ForrestEncoder.g:53:4: ^( CONSTANT IDENTIFIER expr )
					{
	...
	public final void expr() throws RecognitionException {
		...
		try {
			// ForrestEncoder.g:63:2: ( ^( BECOMES id= IDENTIFIER expr ) | ^( EXPR_WHILE while_comp do_comp ) | ^( EXPR_IF if_comp then_comp ( else_comp )? ) | ^( ( LOGOR | LOGAND | GREATER | SMALLER | GREATEREQ | SMALLEREQ | EQUALS | NOTEQUALS | PLUS | MINUS | TIMES | DIVIDE | MODULO ) expr expr ) | ^( ( POSITIVE | NEGATIVE | NOT ) expr ) | ^( COMPOUND program_lines ) | IDENTIFIER | NUMBER | ( TRUE | FALSE ) | CHARACTER | read | print )
			int alt5=12;
			switch ( input.LA(1) ) {
			case BECOMES:
				{
			...
			switch (alt5) {
				case 1 :
					// ForrestEncoder.g:63:5: ^( BECOMES id= IDENTIFIER expr )
					{
					...
					break;
				case 2 :
					// ForrestEncoder.g:67:4: ^( EXPR_WHILE while_comp do_comp )
					{
					...
					break;
				case 3 :
					// ForrestEncoder.g:79:4: ^( EXPR_IF if_comp then_comp ( else_comp )? )
					{
					...
					// ForrestEncoder.g:92:3: ( else_comp )?
					int alt4=2;
					...
					switch (alt4) {
						case 1 :
							// ForrestEncoder.g:93:3: else_comp
							{
					...
					break;
				case 4 :
					// ForrestEncoder.g:105:4: ^( ( LOGOR | LOGAND | GREATER | SMALLER | GREATEREQ | SMALLEREQ | EQUALS | NOTEQUALS | PLUS | MINUS | TIMES | DIVIDE | MODULO ) expr expr )
					{
					...
					break;
				case 5 :
					// ForrestEncoder.g:108:4: ^( ( POSITIVE | NEGATIVE | NOT ) expr )
					{
					...
					break;
				case 6 :
					// ForrestEncoder.g:110:6: ^( COMPOUND program_lines )
					{
					 fw.openScope(); 
					match(input,COMPOUND,FOLLOW_COMPOUND_in_expr344); 
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						pushFollow(FOLLOW_program_lines_in_expr346);
						program_lines();
						state._fsp--;
					...
					break;
				case 7 :
					// ForrestEncoder.g:113:4: IDENTIFIER
					{
					match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_expr356); 
				...
				case 8 :
					...
					break;
				case 9 :
					// ForrestEncoder.g:118:4: ( TRUE | FALSE )
					{
					...
					break;
				case 10 :
					// ForrestEncoder.g:119:4: CHARACTER
					{
					match(input,CHARACTER,FOLLOW_CHARACTER_in_expr385); 
					fw.writeCharacter(t);
					}
					break;
				case 11 :
					// ForrestEncoder.g:120:4: read
					{
					pushFollow(FOLLOW_read_in_expr392);
					read();
					state._fsp--;
					...
					break;
				case 12 :
					// ForrestEncoder.g:121:4: print
					{
					pushFollow(FOLLOW_print_in_expr397);
					print();
					state._fsp--;
	...
	// ForrestEncoder.g:124:1: while_comp : ^( WHILE program_lines ) ;
	public final void while_comp() throws RecognitionException {
		try {
			// ForrestEncoder.g:125:2: ( ^( WHILE program_lines ) )
			// ForrestEncoder.g:125:4: ^( WHILE program_lines )
			{
			match(input,WHILE,FOLLOW_WHILE_in_while_comp409); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				pushFollow(FOLLOW_program_lines_in_while_comp411);
				program_lines();
				state._fsp--;
	...
	// $ANTLR start "do_comp"
	// ForrestEncoder.g:128:1: do_comp : ^( DO program_lines ) ;
	public final void do_comp() throws RecognitionException {
		try {
			// ForrestEncoder.g:129:2: ( ^( DO program_lines ) )
			// ForrestEncoder.g:129:4: ^( DO program_lines )
			{
			match(input,DO,FOLLOW_DO_in_do_comp424); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				pushFollow(FOLLOW_program_lines_in_do_comp426);
				program_lines();
				state._fsp--;
	...
	// $ANTLR start "if_comp"
	// ForrestEncoder.g:132:1: if_comp : ^( IF program_lines ) ;
	public final void if_comp() throws RecognitionException {
		try {
			// ForrestEncoder.g:133:2: ( ^( IF program_lines ) )
			// ForrestEncoder.g:133:4: ^( IF program_lines )
			{
			match(input,IF,FOLLOW_IF_in_if_comp439); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				pushFollow(FOLLOW_program_lines_in_if_comp441);
				program_lines();
				state._fsp--;
	...
	// ForrestEncoder.g:136:1: then_comp : ^( THEN program_lines ) ;
	public final void then_comp() throws RecognitionException {
		try {
			// ForrestEncoder.g:137:2: ( ^( THEN program_lines ) )
			// ForrestEncoder.g:137:4: ^( THEN program_lines )
			{
			match(input,THEN,FOLLOW_THEN_in_then_comp454); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				pushFollow(FOLLOW_program_lines_in_then_comp456);
				program_lines();
				state._fsp--;
	...
	// ForrestEncoder.g:140:1: else_comp : ^( ELSE program_lines ) ;
	public final void else_comp() throws RecognitionException {
		try {
			// ForrestEncoder.g:141:2: ( ^( ELSE program_lines ) )
			// ForrestEncoder.g:141:4: ^( ELSE program_lines )
			{
			match(input,ELSE,FOLLOW_ELSE_in_else_comp469); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				pushFollow(FOLLOW_program_lines_in_else_comp471);
				program_lines();
				state._fsp--;
	...
	// $ANTLR start "read"
	// ForrestEncoder.g:144:1: read : ^( READ (id= IDENTIFIER )+ ) ;
	public final void read() throws RecognitionException {
		...
		try {
			// ForrestEncoder.g:148:2: ( ^( READ (id= IDENTIFIER )+ ) )
			// ForrestEncoder.g:148:4: ^( READ (id= IDENTIFIER )+ )
			{
			match(input,READ,FOLLOW_READ_in_read490); 
			match(input, Token.DOWN, null); 
			// ForrestEncoder.g:148:11: (id= IDENTIFIER )+
			int cnt6=0;
			loop6:
			while (true) {
				int alt6=2;
				...
				switch (alt6) {
				case 1 :
					// ForrestEncoder.g:148:12: id= IDENTIFIER
					{
					id=(ForrestTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_read495); 
					}
					break;
	...
	// $ANTLR start "print"
	// ForrestEncoder.g:152:1: print : ^( PRINT ( expr )+ ) ;
	public final void print() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestEncoder.g:156:2: ( ^( PRINT ( expr )+ ) )
			// ForrestEncoder.g:156:4: ^( PRINT ( expr )+ )
			{
			match(input,PRINT,FOLLOW_PRINT_in_print521); 
			match(input, Token.DOWN, null); 
			// ForrestEncoder.g:156:12: ( expr )+
			int cnt7=0;
			loop7:
			while (true) {
				int alt7=2;
				...
				switch (alt7) {
				case 1 :
					// ForrestEncoder.g:156:13: expr
					{
					pushFollow(FOLLOW_expr_in_print524);
					expr();
					state._fsp--;
	...
	public static final BitSet FOLLOW_COMPOUND_in_expr344 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_program_lines_in_expr346 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_IDENTIFIER_in_expr356 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NUMBER_in_expr365 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_set_in_expr372 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_CHARACTER_in_expr385 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_read_in_expr392 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_print_in_expr397 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_WHILE_in_while_comp409 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_program_lines_in_while_comp411 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_DO_in_do_comp424 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_program_lines_in_do_comp426 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_IF_in_if_comp439 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_program_lines_in_if_comp441 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_THEN_in_then_comp454 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_program_lines_in_then_comp456 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_ELSE_in_else_comp469 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_program_lines_in_else_comp471 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_READ_in_read490 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_IDENTIFIER_in_read495 = new BitSet(new long[]{0x0000000002000008L});
	public static final BitSet FOLLOW_PRINT_in_print521 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expr_in_print524 = new BitSet(new long[]{0x003327FCC3F84898L});
}
