// $ANTLR 3.5 ForrestEncoder.g 2013-06-29 13:27:00
...
public class ForrestEncoder extends TreeParser {
	...
	// ForrestEncoder.g:42:1: program_lines : ( ( declaration )* expr )* ;
	public final void program_lines() throws RecognitionException {
		try {
			// ForrestEncoder.g:43:2: ( ( ( declaration )* expr )* )
			// ForrestEncoder.g:43:4: ( ( declaration )* expr )*
			{
			// ForrestEncoder.g:43:4: ( ( declaration )* expr )*
			loop2:
			while (true) {
				...
				switch (alt2) {
				case 1 :
					// ForrestEncoder.g:43:5: ( declaration )* expr
					{
					// ForrestEncoder.g:43:5: ( declaration )*
					loop1:
					while (true) {
						int alt1=2;
						...
						switch (alt1) {
						case 1 :
							// ForrestEncoder.g:43:6: declaration
							{
	...
	// ForrestEncoder.g:47:1: declaration : ( ^( VAR IDENTIFIER ( CHAR | BOOL | INT ) ) | ^( CONSTANT IDENTIFIER expr ) );
	public final void declaration() throws RecognitionException {

		ForrestTree t = (ForrestTree)input.LT(1);

		try {
			// ForrestEncoder.g:51:2: ( ^( VAR IDENTIFIER ( CHAR | BOOL | INT ) ) | ^( CONSTANT IDENTIFIER expr ) )
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// ForrestEncoder.g:51:4: ^( VAR IDENTIFIER ( CHAR | BOOL | INT ) )
					{
					...
					break;
				case 2 :
					// ForrestEncoder.g:55:4: ^( CONSTANT IDENTIFIER expr )
					{
	...
	public final void expr() throws RecognitionException {
		...
		try {
			// ForrestEncoder.g:65:2: ( ^( BECOMES id= IDENTIFIER expr ) | ^( EXPR_WHILE while_comp do_comp ) | ^( EXPR_IF if_comp then_comp ( else_comp )? ) | ^( ( LOGOR | LOGAND | GREATER | SMALLER | GREATEREQ | SMALLEREQ | EQUALS | NOTEQUALS | PLUS | MINUS | TIMES | DIVIDE | MODULO ) expr expr ) | ^( ( POSITIVE | NEGATIVE | NOT ) expr ) | ^( COMPOUND program_lines ) | IDENTIFIER | NUMBER | ( TRUE | FALSE ) | CHARACTER | read | print )
			int alt5=12;
			switch ( input.LA(1) ) {
			case BECOMES:
				{
			...
			switch (alt5) {
				case 1 :
					// ForrestEncoder.g:65:5: ^( BECOMES id= IDENTIFIER expr )
					{
					...
					break;
				case 2 :
					// ForrestEncoder.g:69:4: ^( EXPR_WHILE while_comp do_comp )
					{
					...
					break;
				case 3 :
					// ForrestEncoder.g:81:4: ^( EXPR_IF if_comp then_comp ( else_comp )? )
					{
					...
					// ForrestEncoder.g:94:3: ( else_comp )?
					int alt4=2;
					...
					break;
				case 4 :
					// ForrestEncoder.g:107:4: ^( ( LOGOR | LOGAND | GREATER | SMALLER | GREATEREQ | SMALLEREQ | EQUALS | NOTEQUALS | PLUS | MINUS | TIMES | DIVIDE | MODULO ) expr expr )
					{
					...
					break;
				case 5 :
					// ForrestEncoder.g:110:4: ^( ( POSITIVE | NEGATIVE | NOT ) expr )
					{
					...
					break;
				case 6 :
					// ForrestEncoder.g:112:6: ^( COMPOUND program_lines )
					{
