...
public class ForrestOptions {
	...
	public ForrestOptions(boolean parser, boolean checker, 
		...
		this.inputFileLocation = "../program/Forrest/" + inputFileLocation + ".forrest";
		this.tasmFileLocation = "../program/TAM/" + tasmFileLocation + ".tasm";
	...
	protected String tamFileLocation = "../program/TAM/program.tam";
